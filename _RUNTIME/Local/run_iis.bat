...
@echo.
@echo Starting process '"C:\Program Files\IIS Express\iisexpress.exe" /config:"%~dp0localhost.config" /site:%projectname% /systray:false'
"C:\Program Files\IIS Express\iisexpress.exe" /config:"%~dp0localhost.config" /site:%projectname% /systray:false

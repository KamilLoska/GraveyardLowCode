<%@ Page Title="Documents" Language="C#" MasterPageFile="~/MasterPages/Site.Master" Inherits="VBP_WebUI.Pages.Documents" CodeBehind="Documents.aspx.cs" %>
...
<asp:Content runat="server" ID="ContentPlaceHolder" ContentPlaceHolderID="MC">
   <sec:VBPSecurityControl ID="m_se" AvoidDoubleClick="true" runat="server" AvoidSingleOpening="false" />

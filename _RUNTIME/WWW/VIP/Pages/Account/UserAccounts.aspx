<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Default.Master" CodeBehind="UserAccounts.aspx.cs" Inherits="Account.Web.UserAccounts" %>
...
<asp:Content ContentPlaceHolderID="_mainContentPlaceHolder" runat="server">
   <acc:UserAccountNavigation ID="m_navigator" Width="100%" runat="server" />
</asp:Content>
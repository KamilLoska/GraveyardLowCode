...
The RPMS (or DEBS, respectively) directory also contains a package named libreoffice6.1-freedesktop-menus-6.1.0.1-1.noarch.rpm (or libreoffice6.1-debian-menus_6.1.0.1-1_all.deb, respectively, or similar). This is a package for all Linux distributions that support the Freedesktop.org specifications/recommendations (https://en.wikipedia.org/wiki/Freedesktop.org), and is provided for installation on other Linux distributions not covered in the aforementioned instructions.
...
Our system for reporting, tracking and solving bugs is currently Bugzilla, hosted at http://bugs.documentfoundation.org/. We encourage all users to feel entitled and welcome to report bugs that may arise on your particular platform. Energetic reporting of bugs is one of the most important contributions that the user community can make to the ongoing development and improvement of LibreOffice.
...
We hope you enjoy working with the new LibreOffice 6.1 and will join us online.
